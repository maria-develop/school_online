...
class LessonTests(APITestCase):
    ...
    def test_lesson_retrieve(self):
        ...
        self.assertEqual(data.get("name_lesson"), self.lesson.name_lesson)
    ...
    def test_lesson_update(self):
        ...
        data = response.json()
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(data.get("name_lesson"), "Курс тайского")
...
class SubscriptionTests(APITestCase):
    ...
    def test_subscription_update(self):
        ...
        subscription = Subscription.objects.create(
            user=self.user, course=self.course, name_subscription="Старая подписка"
        )

        url = reverse("ims:subscription")
        data = {"id": self.course.pk, "name_subscription": "Курс тайского"}
        ...
        self.assertEqual(data_resp.get("name_subscription"), "Курс тайского")
